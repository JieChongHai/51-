                        ...
                        <div class="ibox-content">
                            ...
                            <div class="col-sm-4">
                                <div class="input-button">
                                    <a href="<?php echo U('addEditGoodsType');?>">
                                        <button class="btn btn-primary add" type="button"><i class="fa fa-plus"></i>&nbsp;新增</button>
                                    </a>
                                    <button class="btn btn-warning delete-all" type="button" url="/app/index.php/Admin/HighLevel/delAll.html"><i class="fa fa-minus "></i>&nbsp;删除</button>
                                </div>
                            </div>
                            <!-- 新增和删除结束 -->
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <?php if(is_array($goodsTypeList)): $i = 0; $__LIST__ = $goodsTypeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo U('Admin/GoodsAttribute/goodsAttributeList',array('type_id'=>$list['id']));?>" title="" class="btn btn-info">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a href="<?php echo U('addEditGoodsType',array('id'=>$list['id']));?>"  title="" class="btn btn-primary">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a href="javascript:del_fun('<?php echo U('delGoodsType',array('id'=>$list['id']));?>');"   class="btn btn-danger">
